under the MIT Li# 💬 e-commerce chatbot (Gen AI RAG project using LLama3.3 and GROQ)
...
![product screenshot](app/resources/ecommerce_tool_ss.png)
...
Additional Terms: This software is licensed. However, commercial use of this software is strictly prohibited without prior written permission from the author. Attribution must be given in all copies or substantial portions of the software.